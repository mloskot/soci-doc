...
===============================================================================
SOCI 3.1.0 Documentation
===============================================================================

he picture below presents the structure of the library, together with its clients
and servers. The boxes filled with cyan represent components that are
part of the library distribution.

.. image:: ../_images/structure.png
   :alt: SOCI library structure diagram
